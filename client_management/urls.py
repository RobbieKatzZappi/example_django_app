...
urlpatterns = [
    ...
    path('client/<int:client_id>/documents/', views.documents, name='documents'),
    path('download_document/<int:document_id>', views.download_document, name='downloadl_document'),
